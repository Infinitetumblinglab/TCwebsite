...
import { Navigation, Baby, FileText, Heart, Brain, Camera, Menu, X, ArrowDown, Sparkles, Shield, Users, Zap } from 'lucide-react';
...
function MainContent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-teal-50 to-purple-50">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a href="#product" className="text-gray-600 hover:text-teal-600 transition">Product</a>
              ...
              <button className="bg-gradient-to-r from-teal-500 to-purple-500 text-white px-6 py-2 rounded-full hover:shadow-lg transition duration-300">
                Get Started
              </button>
            </div>
        ...
        <div className={`md:hidden transition-all duration-300 ${
          ...
          <div className="px-4 py-4 space-y-4">
            ...
            <a href="#product" className="block text-gray-600 hover:text-teal-600">Product</a>
            ...
            <button className="w-full bg-gradient-to-r from-teal-500 to-purple-500 text-white px-6 py-2 rounded-full">
              Get Started
            </button>
          </div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <button className="bg-gradient-to-r from-teal-500 to-purple-500 text-white px-8 py-4 rounded-full hover:shadow-lg transition duration-300 flex items-center group">
                Discover More 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button className="bg-gradient-to-r from-teal-500 to-purple-500 text-white px-6 py-3 rounded-full hover:shadow-lg transition duration-300">
                Learn More About Us
              </button>
            </div>
            <div className="relative">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-b from-white to-teal-50 pt-12 pb-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 text-center text-gray-600">
            <p>&copy; 2024 Teal Canoe. All rights reserved.</p>
          </div>
        </div>
      </footer>
